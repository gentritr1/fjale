...
const PUBLISHED_CATALOG_SHA256 =
...
test("keeps the published 62-word catalog stable for daily puzzles and challenges", () => {
  ...
  assert.equal(digest, PUBLISHED_CATALOG_SHA256);
});
